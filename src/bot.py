...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # Don't clear history on start - only use /clear for that
    # clear_history(user_id)  # REMOVED: Let users keep their context
    ...
    if personal_mode:
        ...
        if not user_history:
            ...
            await update.message.reply_text(
                "👋 Welcome! I'm MindMate, your personal AI therapist.\n\n"
                "I'm here to support you with direct, honest guidance. "
                "To get started, I'd love to learn about you!\n\n"
                "What should I call you, and what kind of support are you looking for? 💙"
            )
        else:
            # Returning user
            await update.message.reply_text(
